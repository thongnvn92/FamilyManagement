        ...
        res = `<div class="col-md-6 calendar-container text-center">
            <div class="border">
                <div class="header-calendar d-flex justify-content-between fs-5">
                    <div>THÁNG <span class="calendar-month">${(today.getMonth() + 1)}</span></div>
                    <div><span class="calendar-year">${today.getFullYear()}</span></div>
                ...
                <div class="p-2 d-flex justify-content-between">
                    ...
                    <div class="d-grid">
                        <span class="fs-6">Tuần <span class="day-tuan">${TUAN[(currentLunarDate.jd + 1) % 7]}</span></span>
                ...
                <div class="border-primary border-start p-2 mx-auto w-75">
                    <p class="text-left fst-italic" style="font-size: 0.8rem;">
                        Giờ hoàng đạo: <span class="calendar-hoangdao">${getGioHoangDao(currentLunarDate.jd)}</span>
                    </p>
                </div>
                <p class="text-center" style="font-size: 0.9rem;">Tiết <span class="text-primary lunar-tiet-name">${TIETKHI[getSunLongitude(currentLunarDate.jd + 1, 7.0)]}</span> | Phật Lịch:
                    <span class="calendar-phatlich">${getPhatLich()}</span></p>
                <hr>
                <div class="info-container p-2 d-flex justify-content-between align-items-start">
                    ...
                    <div class="d-grid">
                        ...
                        <span class="fs-1 lunar-day-num">${currentLunarDate.day}</span>
